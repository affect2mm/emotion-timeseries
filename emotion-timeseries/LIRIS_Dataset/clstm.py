...
class LSTM(nn.Module):
    def __init__(self, num_series, hidden, batch_first=True):
        ...
        # Set up network.
        self.lstm = nn.LSTM(num_series, hidden, batch_first=batch_first)
...
class cLSTM(nn.Module):
    def __init__(self, num_series, hidden, batch_first=True):
        ...
        # Set up networks.
        self.networks = [LSTM(num_series, hidden, batch_first=batch_first) for _ in range(num_series)]
...
class cLSTMSparse(nn.Module):
    def __init__(self, num_series, sparsity, hidden, batch_first=True):
        ...
        self.networks = []
        for i in range(num_series):
            num_inputs = int(torch.sum(self.sparsity[i].int()))
            self.networks.append(LSTM(num_inputs, hidden, batch_first=batch_first))
